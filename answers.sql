...
SELECT m.name, m.brand_name, b.headquarters FROM brands AS b JOIN models AS m ON b.name = m.brand_name WHERE m.name  = 'Mustang';
...
SELECT m.name, m.brand_name, b.founded FROM models AS m LEFT JOIN brands AS b ON m.brand_name = b.name WHERE year = '1960';
